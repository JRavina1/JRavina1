...
**Wireshark • Packet Analysis • Bash • Azure •PowerShell • Kali Linux • Hashcat/Metasploit • Burp Suite • Vulnerability networking scanning • Incident response • Monitoring & Logs • Network scanning** 
...
🔹 **SMART-AI Hospital Dashboard**  
A real-world data dashboard built with Python for visualising hospital operations and insights.

🔹 **Data Warehouse**  
Currently building a real-world Modern Data Warehouse using SQL. 
